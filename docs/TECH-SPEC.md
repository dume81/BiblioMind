...
> 상태: **v2.2 — v2.1(AuraDB 전환·스캐폴딩 패널 반영) 후 총감사(패널 8인) 개정: 검증 계획 6(호출률·부정 대조) 신설, §5.5 404 비치명 처리, §6.4 Aura RTT 재산정, citation 문구 정직화, 과잉 인용 경고, 잠금 감지, README 목차 ⑮~⑰, 부록 A 3건 해소, 신형 콘솔 자격증명 정정 (상세는 부록 C·DECISIONS.md)**  · **v2.3(2026-08-22 유지보수 M2·M3): §6.2.3 질문 원문 앵커 복원 / §6.3 T2 점수 하한 / §6.4 상한 3행 / §4.3-13 인용 밀도 안내 정직화 / §1.14 가정 7행 신설**| 최종 수정: 2026-08-22
